  ...
  return (
    <button
      ...
      className={classNames(
        ' border border-solid border-transparent inline-flex items-center justify-center transition-all outline-none leading-[20px] text-[13px] ',
        ...
        }[size],
        {
          ...
          danger:
            ' bg-bgPrimaryQuaternary text-textBaseDefault not-disabled:hover:bg-[#e8777b]  not-disabled:active:bg-[#d54b4d] ',
          secondary:
